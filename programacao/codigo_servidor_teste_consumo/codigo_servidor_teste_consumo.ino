...
const char* password = "82668266123";
...
byte pinosDigitais[qtdePinosDigitais] = {2           , 5     , 4     , 12     , 13     , 14     , 15     };
            ...
            if (client.available()) { 
                ...
                if (c == '\n' && currentLineIsBlank ) { 
                    ...
                    if ( mainPageRequest(&HTTP_req) ) {
                        ...
                        client.println("<head>");
                        client.println("<title>ESP test server</title>");
                        ...
                        client.println("<br/>");
                        client.println("porta 04 = LED  Azul 3<br/>");
                        client.println("porta 05 = LED  Azul 4<br/>");
                        client.println("porta 12 = LED VERDE 3<br/>");
                        client.println("porta 13 = LED VERDE 2<br/>");
                        client.println("porta 14 = LED VERDE 4<br/>");
                        client.println("porta 15 = LED VERDE 1<br/>");
